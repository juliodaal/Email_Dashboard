...
class Sidebar extends React.Component {
    ...
    render(){
        return(
            <div className={"h-screen col-span-2 flex flex-col justify-between"}>
                <div>
                    {/* Compose Email */}
                    <div>
                ...
                <div>
                    <ul className={"my-6 px-6"}>
                        <li>
                            <button className={"w-full flex justify-start items-center py-2 px-6 rounded-md hover:bg-gray-100 text-gray-600"}>
